<?php
  ...
  session_start();
   $email= $_SESSION['email'];
    ...
    $query1="SELECT * from choreographer;";
...
<h3 style="background-color:black; color:white;"> H E L L O  <?php print_r($username); ?> ! </h3>
        ...
        <div class="container" style="padding-top:150px;">
                ...
                <div class="text-center" style=" color:white; border-color:blue; opacity:0.9;">
                  <br>
                   <h4><b style="color:black;">Full name:</b> <?php print_r($row['choreographer']);  ?></h4>
                       <h4><b style="color:black;">Mail ID:</b> <?php print_r($row['email']);  ?></h4>
                       <h4 ><b style="color:black;">Username:</b>
                          <?php print_r($row['username']);  ?></h4>
                          <h4><b style="color:black;">Dance Style Specialist:</b> <?php print_r($row['style']); ?></h4>
                           <h4><b style="color:black;">Cost per month:</b> Rs.<?php print_r($row['cost']);   ?></h4>
                  <hr>
                  <br>
</div><?php }; ?>
            </div>
    ...
    <div class="text-center">
      <form>
        <button class="button" formaction="ad_profile.php"><span>Profile</span></button>
          <button class="button" formaction="choreographer.html"><span>Details</span></button>
      </form>
    </div>
    <section>
