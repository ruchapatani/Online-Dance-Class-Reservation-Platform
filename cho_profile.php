...
<h3 style="background-color:black; color:white;"> H E L L O  <?php print_r($choreographer); ?> ! </h3>
        ...
        <div class="container" style="padding-top:150px;">
                ...
                <div class="text-center" style=" color:white; border-color:blue; opacity:0.9;">
                  <br>
                  <h4 ><b style="color:black;">SPECIALIST:</b>
                     <?php print_r($row['style']);  ?></h4>
                  <h4><b style="color:black;">FEES :</b> <?php print_r($row['cost']); ?></h4>
                  <h4><b style="color:black;">USERNAME :</b> <?php print_r($row['choreographer']);   ?></h4>
    ...
    <div class="text-center">
      <form>
        <button class="button" formaction="cho_class.php"><span>Classes</span></button>
      </form>
    </div>
