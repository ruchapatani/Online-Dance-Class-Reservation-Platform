<?php
  ...
  session_start();
   $email= $_SESSION['email'];
    ...
    //$query1="SELECT * from choreographer where email='$email'";
...
<h3 style="background-color:black; color:white;"> H E L L O  <?php print_r($username); ?> ! </h3>
        ...
        <div class="container" style="padding-top:150px;">
                ...
                <div class="text-center" style=" color:white; border-color:blue; opacity:0.9;">
                  <br>
                  <h4 >Admin access to the numbers of students enrolled , different dance form classes and the Choreographers.</h4>
    ...
    <div class="text-center">
      <form>
        <button class="button" formaction="ad_stu.php"><span>Students</span></button>
          <button class="button" formaction="ad_class.php"><span>Classes</span></button>
            <button class="button" formaction="ad_cho.php"><span>Choreographers</span></button>
      </form>
    </div>
